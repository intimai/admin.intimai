    ...
    <div className="flex h-screen bg-background overflow-hidden">
      ...
      <aside className="w-64 border-r border-border bg-card hidden md:flex flex-col shadow-sm z-10">
        ...
        <nav className="flex-1 p-4 space-y-2 overflow-y-auto py-6">
          ...
          <NavItem to="/intimacoes" icon={FileText} label="Intimações" />
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        {/* Top Header */}
        <header className="bg-card/60 border-b border-border h-16 flex items-center justify-end px-6 sticky top-0 z-30 backdrop-blur-sm">
        ...
        {/* Page Content */}
        <main className="flex-1 overflow-auto bg-muted/10 relative p-6">
